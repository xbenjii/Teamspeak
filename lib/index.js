...
var TS3 = (function (_EventEmitter) {
	...
	function TS3() {
		...
		this.connected = new _bluebird2['default'](function (resolve) {
	...
	_createClass(TS3, [{
		...
		value: function onData(line) {
			...
			if (line.indexOf("error") !== -1) {
				...
				this.promise.resolve(_utils2['default'].parseResponse(line));
			}
		}
	}, {
		key: 'send',
		value: function send(command) {
			...
			this._promiseChain = this._promiseChain.then(function () {
				return new _bluebird2['default'](function (resolve, reject) {
					...
					_this2.socket.write(_utils2['default'].buildCommand(command, data) + '\n');
				});
			});
